...
def embed(request, poll_id):
    ...
    return render_to_response('poll_frame.html', {'poll_id': poll_id})
    ...
    if request.method == 'POST':
        ...
        if poll_form.is_valid():
            ...
            if answer_formset.is_valid():
                answer_formset.save()
                return HttpResponseRedirect(reverse('askmeanything.views.publish', kwargs={'poll_id': new_poll.id}))
            else:
                new_poll.delete()
