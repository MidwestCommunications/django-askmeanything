...
class Migration:
    ...
    def forwards(self, orm):
        if db.backend_name == 'sqlite3':
            orm['askmeanything.poll:creator'].null = True
        # Adding field 'Poll.creator'
        db.add_column('askmeanything_poll', 'creator', orm['askmeanything.poll:creator'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Poll.creator'
        db.delete_column('askmeanything_poll', 'creator_id')
    ...
    models = {
        ...
        'askmeanything.publishedpoll': {
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'poll': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'publishings'", 'to': "orm['askmeanything.Poll']"}),
